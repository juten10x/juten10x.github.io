...
### juten10xについて
juten10x という HN は、結構気に入ってます。特に、誰とも被っていないという点。試しに Google 検索してみても、私に関係するものしか出てきません。 Microsoft Edge はこの限りではありませんが、リザルトの一番上にはこのサイトが表示されます。また、 juten10x と完全に一致する検索結果としては私に関するもののみとなります。実際、これまでこの HN で登録できなかったサービスはありませんでした<sup><a id="_note2" href="#note2">[注 2]</a>。また、数字が入っているというのも嬉しいところ。アルファベットだけでなく数字も含まれていることでメリハリがつきます。
