...
（以下の文章は、私が[noteに書いた感想](https://note.com/juten10x/n/na2fb3fca5fb4)と同じものです。ここでは、長文をこのサイト内に表示した場合のサンプルとして、またはブログにおける画像の使い方の練習として使っています。なので、関係ない風景の画像とかを文章中に挟んでいたりします。）
...
<figure>
  <img id="_image2" src="../pile_of_images/me-15.jpg" />
